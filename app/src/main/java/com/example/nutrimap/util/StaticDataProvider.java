...
public class StaticDataProvider {
    ...
    private List<Visit> createMockVisits() {
        ...
        // Child 1 visits
        list.add(new Visit(1, 1, "2024-01-15", 8.5, 72.0, 130, "Healthy checkup"));
        list.add(new Visit(2, 1, "2024-04-20", 9.2, 76.0, 135, "Growing well"));
        list.add(new Visit(3, 1, "2024-07-10", 9.8, 80.0, 140, ""));
        // Child 2 visits - some concern
        list.add(new Visit(4, 2, "2024-02-05", 7.0, 68.0, 118, "Moderate concern"));
        list.add(new Visit(5, 2, "2024-05-12", 7.5, 71.0, 122, "Slight improvement"));
        list.add(new Visit(6, 2, "2024-08-18", 8.0, 74.0, 126, "Recovered well"));
        // Child 3 visits - high risk case
        list.add(new Visit(7, 3, "2024-03-01", 5.5, 60.0, 108, "SAM detected"));
        list.add(new Visit(8, 3, "2024-04-15", 6.0, 62.0, 112, "Under treatment"));
        list.add(new Visit(9, 3, "2024-06-01", 6.8, 65.0, 118, "Improving"));
        // Child 4 visits
        list.add(new Visit(10, 4, "2024-01-20", 9.0, 74.0, 138, ""));
        list.add(new Visit(11, 4, "2024-05-25", 9.8, 78.0, 142, ""));
        // Child 5 visits - moderate risk
        list.add(new Visit(12, 5, "2024-02-10", 10.0, 82.0, 120, "MAM detected"));
        list.add(new Visit(13, 5, "2024-06-15", 10.5, 85.0, 128, "Better now"));
        // Child 6 visits
        list.add(new Visit(14, 6, "2024-03-08", 8.2, 70.0, 132, ""));
        list.add(new Visit(15, 6, "2024-07-20", 9.0, 75.0, 138, ""));
        // Child 7 visits
        list.add(new Visit(16, 7, "2024-04-05", 6.0, 58.0, 145, ""));
        // Child 8 visits - high risk
        list.add(new Visit(17, 8, "2024-01-25", 8.0, 75.0, 110, "Severe case"));
        list.add(new Visit(18, 8, "2024-03-30", 8.5, 77.0, 115, "Ongoing treatment"));
        list.add(new Visit(19, 8, "2024-06-10", 9.2, 80.0, 123, "Recovering"));
        // Child 9 visits
        list.add(new Visit(20, 9, "2024-02-18", 9.5, 78.0, 140, ""));
        list.add(new Visit(21, 9, "2024-08-05", 10.2, 83.0, 145, ""));
        // Child 10 visits - moderate risk
        list.add(new Visit(22, 10, "2024-05-01", 5.8, 55.0, 118, "MAM noted"));
        list.add(new Visit(23, 10, "2024-08-15", 6.5, 60.0, 125, "Improving"));
        return list;
    }
